...
//import com.hanson.base.response.EdgeResponseCode;
...
//		if(systemUser == null){
//			return ResponseData.fail(EdgeResponseCode.SYSTEM_USER_NOT_FOUND);
//		}
...
//		if(id == null || id < 0) {
//			throw new ControllerException(EdgeResponseCode.PARAM_ERROR);
//		}
