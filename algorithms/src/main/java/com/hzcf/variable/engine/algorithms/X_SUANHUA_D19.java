 ...
 **/
public class X_SUANHUA_D19 extends AbstractAlgorithms {
	public Object execute(String param) throws Exception {
		...
		for (Object obj : jsonArray) {
			...
			if(subJson.get("bankLostContact")!=null && subJson.get("bankLostContact").toString().length()>0){
				String date_str = subJson.get("bankLostContact").toString();
