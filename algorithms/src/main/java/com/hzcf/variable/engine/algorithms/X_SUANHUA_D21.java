 ...
 **/
public class X_SUANHUA_D21 extends AbstractAlgorithms {
	public Object execute(String param) throws Exception {
		...
		for (Object obj : jsonArray) {
			...
			if(subJson.get("seriousOverdueTime")!=null && subJson.get("seriousOverdueTime").toString().length()>0){
				String date_str = subJson.get("seriousOverdueTime").toString();
