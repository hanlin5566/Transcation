...
public class BundleConf {
	...
	public static HashMap<String, Mail> MAIL_TEMPLATE = new HashMap<String, Mail>();
	public static HashMap<String, SyncData> SYNC_DATA_TEMPLATE = new HashMap<String, SyncData>();
