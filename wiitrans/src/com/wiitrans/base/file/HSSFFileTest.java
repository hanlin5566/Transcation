...
public class HSSFFileTest {

	public static void main(String[] args) {
		// AppConfig app = new AppConfig();
		// app.Parse();
		WiitransConfig.getInstance(0);
		SSFFileNoTag file = new HSSFFileNoTag();
		// file._tagId = "☂";
		file.Init("/root/Desktop/file/yin1.xls",
				"/root/Desktop/file/yin1_cleanup.xls",
				"/root/Desktop/file/yin1.xml", "yin1.xls", new English(),
				new Chinese());
