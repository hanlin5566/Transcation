package com.wiitrans.opt.spout;
...
//		app.Parse();
		...
		_taskCollector = new TaskCollector(BundleConf.BUNDLE_REPORT_IP,
				...
				BundleConf.OPERATION_BUNDLE_ID);
